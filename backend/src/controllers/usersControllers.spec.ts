...
import { deleteUserController, getAllUsersControllers, getSingleUserController, loginUserController, registerUserController, updateUserController } from './usersControllers'
